...
## 🤝 Contributing
This is an open-source project, and we welcome contributions. Please read our [**Contributing Guidelines**](CONTRIBUTING.md) to get started.

---

## ⚖️ License
This project is licensed under **CC BY-NC-ND 4.0**. Commercial use, redistribution, or sale of STL files and printed parts is strictly prohibited.